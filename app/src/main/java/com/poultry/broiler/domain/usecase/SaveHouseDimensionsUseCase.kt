 ...
 */
class SaveHouseDimensionsUseCase @Inject constructor(
...
class DimensionValidationFailure(
    val fieldErrors: Map<com.poultry.broiler.domain.validation.DimensionField, com.poultry.broiler.domain.validation.DimensionErrorCode>,
