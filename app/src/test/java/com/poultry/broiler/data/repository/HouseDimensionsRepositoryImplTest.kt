...
class HouseDimensionsRepositoryImplTest {
    ...
    private val entity = HouseDimensionsEntity(
        id = "id-1",
        projectId = "project-1",
        length = 100.0,
        width = 12.0,
    ...
    @Test
    fun getDimensionsByProjectId_emitsEntityFromDao() = runTest {
    ...
    @Test
    fun getDimensionsByProjectId_emitsNullWhenAbsent() = runTest {
    ...
    @Test
    fun saveDimensions_delegatesToDaoUpsert() = runTest {
    ...
    @Test
    fun deleteDimensionsByProjectId_delegatesToDao() = runTest {
    ...
    private fun assertEqualsVal(actual: HouseDimensions, expected: HouseDimensionsEntity) {
