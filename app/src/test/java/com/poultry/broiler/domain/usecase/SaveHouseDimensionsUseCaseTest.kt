...
class SaveHouseDimensionsUseCaseTest {
    ...
    @Test
    fun invoke_returnsSuccessAndDelegatesToRepository() =
        runTest {
    ...
    @Test
    fun invoke_updatesUpdatedAtTimestamp() =
        runTest {
            val result = useCase(input)
            assertTrue(result.isSuccess)
    ...
    @Test
    fun invoke_returnsFailureWithValidationErrors_whenInvalid() =
        runTest {
    ...
    @Test
    fun invoke_returnsFailureWhenRepositoryThrows() =
        runTest {
